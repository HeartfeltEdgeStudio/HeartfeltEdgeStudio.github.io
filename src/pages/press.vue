      ...
      <div class="w-100">
        <div class="d-flex flex-column justify-center mx-8 my-2 px-16 py-12">
          ...
          <p class="text-secondary text-body-1">
            ...
            tension, and the unraveling of a deeply personal story.
            <br /><br />
            Reality is shifting. Can you make sense of it?
          </p>

          <v-img class="align-end text-white my-10" height="700" src="../assets/art/keyArt.jpg" cover></v-img>
          ...
          <p class="text-secondary text-body-1">
            ...
            echoes of the professor’s past, <span class="font-weight-black text-primary">piecing together a
              story</span> buried beneath layers of thought and emotion.
            <br /><br />
          ...
          <p class="text-secondary text-body-1">
            ...
            countryside, our world feels lived-in—filled with history, yet touched by something just out of reach.
            <br /><br />
          ...
          <p class="text-secondary text-body-1">
            ...
            a love for storytelling, atmosphere, and unique gameplay experiences.
            <br /><br />
            What started as a small group with a big idea has grown into a dedicated team of developers, artists, and
            sound designers, all working together to bring Joyful Masks to life.
            <br /><br />
