    ...
    <v-card :style="cardStyles">
      ...
      <v-card-item>
        <div class="d-flex flex-column">
          ...
          <div class="text-h6 font-weight-regular">
            ...
            Sign up now and <span class="font-weight-bold text-primary">be one of the few to reveal what lies beneath the surface</span>.
          </div>
        </div>
      </v-card-item>
      ...
      <v-card-actions class="d-flex flex-column align-center justify-center">
        ...
        >
          ...
          <input
            type="text"
            name="b_599738d46e1d892b9f695a0f6_fc6bc1565f"
            tabindex="-1"
            value=""
